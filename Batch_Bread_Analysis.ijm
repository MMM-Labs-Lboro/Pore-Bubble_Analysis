...
#@ String (choices={"Filled", "Ring"}, style="radioButtonHorizontal", persist=false) Contain_Ring_Shapes
#@ String (choices={"Tiff", "Jpeg", "PNG"}, style="radioButtonHorizontal", persist=false) Input_Type
#@ String (choices={"Set in File", "Not Set (Global Scale)", "Not Set (Set Individually during Analysis)"}, style="radioButtonHorizontal", persist=false) Scale_Type
#@ String (choices={"No - Original", "Yes - Triangle"}, style="radioButtonHorizontal", persist=false) Second_Attempt
...
if (Scale_Type == "Set in File") {
Scale = "Set";
Scale_Known = 0;
Scale_Distance = 0;
Scale_Units = "mm";
}
if (Scale_Type == "Not Set (Global Scale)") {
Scale = "No-Global";
Dialog.create("Set Global Scale");
Dialog.addNumber("Known Distance (pixels):", 0);
Dialog.addNumber("Measured Distance (units):", 0);
...
if (Scale_Type == "Not Set (Set Individually during Analysis)") {
Scale = "No-Set";
Scale_Known = 0;
Scale_Distance = 0;
Scale_Units = "mm";
...
if(Contain_Ring_Shapes == "Ring") {
Contain_Ring_Shapes = true;
}
else {
Contain_Ring_Shapes = false;
}
if(Second_Attempt == "Yes - Triangle") {
Second_Attempt = true;
}
else {
...
print("Analysis Complete - Remember to copy the Batch Results from the Desktop");